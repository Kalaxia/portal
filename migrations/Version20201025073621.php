...
final class Version20201025073621 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('RENAME TABLE fos_user TO user__users');
        $this->addSql('DROP INDEX UNIQ_957A6479C05FB297 ON user__users');
        $this->addSql('DROP INDEX UNIQ_957A647992FC23A8 ON user__users');
        $this->addSql('DROP INDEX UNIQ_957A6479A0D96FBF ON user__users');
        $this->addSql('ALTER TABLE user__users CHANGE roles legacy_roles LONGTEXT CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\', ADD activation_token VARCHAR(150) DEFAULT NULL, DROP username_canonical, DROP email_canonical, DROP salt, DROP last_login, DROP confirmation_token, DROP password_requested_at, CHANGE username username VARCHAR(255) NOT NULL, CHANGE email email VARCHAR(255) NOT NULL, ADD roles JSON NOT NULL, CHANGE enabled is_enabled TINYINT(1) NOT NULL');
        $this->addSql('UPDATE user__users SET roles = "[]" WHERE 1');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FBE95248F85E0677 ON user__users (username)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_FBE95248E7927C74 ON user__users (email)');
        ...
        $this->addSql('RENAME TABLE notifications TO user__notifications');
        $this->addSql('ALTER TABLE user__notifications DROP FOREIGN KEY FK_6000B0D3A76ED395');
        $this->addSql('ALTER TABLE user__notifications ADD CONSTRAINT FK_6000B0D3A76ED395 FOREIGN KEY (user_id) REFERENCES user__users (id)');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('RENAME TABLE user__users TO fos_user');
        $this->addSql('RENAME TABLE user__notifications TO notifications');
